...
template <typename T>
void print_vector(ft::vector<T> vect)
{
...
int main()
{
    std::cout << "MAIN TESTING FT CONTAINERS\n"; 
    ...
    //iterators
    ft::vector<int>::iterator it = my_vect1.begin();
    ft::vector<int>::iterator ite = my_vect1.end();
    ...
    ft::vector<int> copy(my_vect1);
    ft::vector<int> vect_copy = my_vect1;
    ...
    std::cout << "\nTEST INSERT\n";
    my_map.insert(ft::make_pair(7, 7));
    my_map.insert(ft::make_pair(9, 9));
    for (size_t i = 0; i < 5; i++)
        my_map.insert(ft::make_pair(1 + i, 11 + i));
    ...
    ft::map<int, int>::iterator mite = my_map.end();
    std::cout << "\nprint map\n";
    for (; mit != mite; mit++)
        std::cout << "[" << mit->first << "; " << mit->second << "]\n";

    std::cout << "\nTEST COPY\n";
    ft::map<int, int> copy_map(my_map);
    ...
    std::cout << "\nTEST ERASE\n";
    my_map.erase(7);
    ft::map<int, int>::iterator m = my_map.begin();
    ft::map<int, int>::iterator me = my_map.end();
    std::cout << "\nprint map\n";
    for (; m != me; m++)
